    ...
    <>
      <div className='live_main h-full relative flex '>
        ...
        <div className='absolute h-full w-full top-0'>
          <img className=' w-full' src='https://images.livspace-cdn.com/plain/https://d3gq2merok8n5r.cloudfront.net/img/landingpages/full-home-interiors/Edge_New/new-folder-1657193933-8Jkh5/1440x730-1657194139-erPsT.jpg' title='' />
        </div>
